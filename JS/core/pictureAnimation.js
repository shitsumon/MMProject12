...
function animiereCanvas(canvas_id, bild_id){
	...
	gAnimationTimer[bild_id].bild_nr*gBilder[bild_id].animation.tile_width,
	0,
	gBilder[bild_id].animation.tile_width,
	gBilder[bild_id].abmessungen.height,
	0,0,
	gBilder[bild_id].animation.tile_width,
	gBilder[bild_id].abmessungen.height);

	gAnimationTimer[bild_id].bild_nr=gAnimationTimer[bild_id].bild_nr<gBilder[bild_id].animation.tile_anzahl-1?
...
function starteAnimation(animation){
	animation.timer=window.setInterval(function(){
				...
				(1000/gBilder[animation.bild_id].animation.fps));
